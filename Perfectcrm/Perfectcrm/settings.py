...
SECRET_KEY = '@9ghqftql%o1uni2x@jb9jh7%t37cj%%8umd=pu8p$xkb+e5@f'
...
INSTALLED_APPS = [
    ...
    'PerfectCRM.Perfectcrm.crm',
    'PerfectCRM.Perfectcrm.student',
    'PerfectCRM.Perfectcrm.kind_admin',
    'PerfectCRM.Perfectcrm.video',
...
HOMEWORK_DATA = "%s/homework_data"%BASE_DIR
